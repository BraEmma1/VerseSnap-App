...
Create a full project structure for a MERN stack application (MongoDB, Express, React, Node.js) based on the specification below.

Requirements:
- Separate frontend and backend folders
- Use scalable best practices
- Do NOT write code yet
- Only output folder and file structure
